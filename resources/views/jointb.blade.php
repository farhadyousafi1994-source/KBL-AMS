     ...
     <tbody>
         ...
         <tr>
             ...
             <td>
                 ...
                 <!-- |<a href="{{route('insert' , $dabs->id) }}" class="fa fa-plus-square  fa-hover   btn btn-success btn-xs"   title="جهت اضافه نمودن جنس در ذمت {{$dabs->emp_name}}  فشار دهید!"> </a> -->
                 @endif

                  <!-- <a href = "delete/{{ $dabs->id }}" class="btn btn-danger btn-xs" data-toggle="modal" onclick="return confirm ('Are you sure to delete the data')"    ><i class="fa fa-trash"></i></a></!- -->
             </td>
         </tr>
                         ...
                         <div class="modal-body">
                             ...
                             <div class="formgroup">
                                 ...
                                 <div class="col">
                                     ...
                                     <input type="text" name=" " class="form-control" placeholder="مقام">
                                 </div>

                                 <div class="col">
                                     <label for="fullname">نمبر سند <span class="required">*</span> :</label>

                                     <input type="text" name="" class="form-control" placeholder="دیپارتمنت ">
                                 </div>
                                 <div class="col">
...
<label for=" ">    تحویل دهنده   :</label>
      ...
      <input type="text" name="account_pay"   class="form-control" placeholder="    تخویل دهنده   "   value="{{ $dabs->account_pay }}"  >
      </div>
    <div class="col">
<label for=" ">    ریاست    :</label>

    <input type="text" name="emp_faculty"   class="form-control"  placeholder="ریاست مربوطه"value="{{ $dabs->emp_faculty }}" >
    </div>
    <div class="col">
<label for=" ">     دیپارتمنت    :</label>
...
<label for=" "> اسم جنس  :</label>
 <select  name="item_name" class="searchable-dropdown" style="width:300px">
...
<label for=" ">  کتگوری جنس :</label>
 <select  name="item_dep" class="searchable-dropdown" style="width:300px">
...
<div   id="addationmodal{{$dabs->id}}">
<label for=" ">  مشخصات  جنس :</label>

 <select  name="item_detail" class="searchable-dropdown" style="width:300px">
...
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
  ...
  @foreach($info as $dabs)
    ...
    <input type="text" name="item_cost"   class="form-control"  placeholder="    قیمت" >
      ...
      <div class="col">
<label for=" ">   تاریخ وارده :</label>

  
    <input type="date" name="import_date"   class="form-control"  placeholder="تاریخ وارده" value="{{ $dabs->import_date }}" >
    ...
    <script type="text/javascript"> 
       ...
       $('.searchable-dropdown').select2({
            ...
            placeholder: "جستجو کنید...",
             dropdownParent:('#addationmodal{{$dabs->id}}'),
